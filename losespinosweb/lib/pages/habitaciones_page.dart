...
/// Página que muestra todas las habitaciones activas disponibles para reserva.
/// Si el usuario no ha iniciado sesión, se le solicita hacerlo antes de reservar.
class HabitacionesPage extends StatelessWidget {
  ...
  /// Maneja el proceso de reserva verificando primero la autenticación
  void _handleReservar(BuildContext context, String tipoHabitacion) {
    if (!authService.isLoggedIn) {
      // Mostrar diálogo solicitando inicio de sesión
      showDialog(
        context: context,
  ...
  Widget build(BuildContext context) {
    ...
    // Mostrar estado vacío si no hay habitaciones disponibles
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text('Vuelve pronto para ver nuestras opciones',
                style: TextStyle(
                  fontSize: 16,
...
/// Widget de tarjeta individual para cada habitación.
/// Muestra imágenes, detalles, comodidades y botón de reserva.
...
class _HabitacionCardState extends State<_HabitacionCard> {
                ...
                children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(widget.habitacion.categoria,
                                style: TextStyle(
                                  fontSize: 12,
                  ...
                  Row(
                    children: [
                      ...
                      Text('\$${widget.habitacion.precioBase.toStringAsFixed(0)} COP',
                        style: TextStyle(
                          fontSize: 24,
                          fontWeight: FontWeight.bold,
                          color: Colors.green.shade800
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(widget.habitacion.descripcion,
                            style: TextStyle(
                              fontSize: 14,
                  ...
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: widget.habitacion.comodidades.map((comodidad) => 
                      Container(
                        padding: const EdgeInsets.symmetric(
                          horizontal: 12,
                          vertical: 8
  ...
  /// Construye el carrusel de imágenes de la habitación
        ...
        SizedBox(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (context, index) => ClipRRect(
              ...
              child: Image.asset(
                widget.habitacion.imagenes[index],
                fit: BoxFit.cover,
        ...
        if (widget.habitacion.imagenes.length > 1) ...[
          ...
          Positioned(
            ...
            child: Center(
              child: IconButton(
                onPressed: () {
                  if (_currentImageIndex < widget.habitacion.imagenes.length - 1) {
  ...
  /// Construye una imagen placeholder cuando no hay imágenes disponibles
  ...
  /// Retorna el icono apropiado según el tipo de habitación
  ...
  /// Retorna el icono apropiado para cada comodidad
